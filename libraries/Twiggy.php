...
{
	require_once(TWIGGY_ROOT . '/vendor/twig/twig/lib/Twig/Autoloader.php');
}
...
class Twiggy
{
	...
	public function __construct()
	{
		...
		$this->_themes_base_dir = ($this->_config['include_apppath']) ? JPATH_BASE . $this->_config['themes_base_dir'] : $this->_config['themes_base_dir'];
	 ...
	 * @param   string  $attribute  Attribute of the meta tag attribute
	 *
	 * @return  object  Instance of this class
	 */
	 ...
	 *
	 * @param   string  $name  The name of an existing function
	 *
	 * @return  object  Instance of this class
	 */
	 ...
	 * @param   boolean  $compile  Whether to compile to html
	 *
