<?php  if(!defined('JPATH_BASE')) exit('No direct script access allowed');
...
$config['twiggy']['template_file_ext'] = '.tpl';
...
$config['twiggy']['twig_cache_dir'] = JPATH_BASE . 'cache/twig/';
...
$config['twiggy']['themes_base_dir'] = '/www/';
...
$config['twiggy']['default_layout'] = 'default';
...
$config['twiggy']['default_template'] = 'default';
